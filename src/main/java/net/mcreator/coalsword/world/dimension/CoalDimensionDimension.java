...
package net.mcreator.coalsword.world.dimension;
...
import net.mcreator.coalsword.procedures.CoalDimensionPlayerEntersDimensionProcedure;
import net.mcreator.coalsword.item.CoalDimensionItem;
...
public class CoalDimensionDimension extends CoalswordElements.ModElement {
	@ObjectHolder("coalsword:coaldimension")
	public static final ModDimension dimension = null;
	@ObjectHolder("coalsword:coaldimension_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public CoalDimensionDimension(CoalswordElements instance) {
		super(instance, 50);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("coaldimension"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("coalsword:coaldimension")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("coalsword:coaldimension"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("coalsword:coaldimension"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("coalsword:coalbiome")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new CoalDimensionItem().setRegistryName("coaldimension"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("coaldimension_portal");
		}
		...
		if (event.getTo() == type) {
			{
				...
				CoalDimensionPlayerEntersDimensionProcedure.executeProcedure($_dependencies);
			}
		}
	}
